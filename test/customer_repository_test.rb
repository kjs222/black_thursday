...
class CustomerRepositoryTest < Minitest::Test
  ...
  def setup
    ...
    @customer_repo.add_new(
      {:id        => 1,
      :first_name => "Kerry",
      :last_name  => "Sheldon",
      :created_at => "2012-03-27 14:56:08 UTC",
      :updated_at => "2012-03-28 14:56:08 UTC"}, @se)
    @customer_repo.add_new(
      {:id => 2,
      :first_name => "Colin",
      :last_name  => "Osborn",
      :created_at => "2012-03-26 14:56:08 UTC",
      :updated_at => "2012-03-27 14:56:08 UTC"}, @se)
    @customer_repo.add_new(
      {:id => 3,
      :first_name => "Fernando",
      :last_name  => "Alonso",
      :created_at => "2012-03-25 14:56:08 UTC",
      :updated_at => "2012-03-25 14:56:08 UTC"}, @se)
  end
  ...
  def test_all_finds_all
    assert_equal 3, customer_repo.all.length
  end

  def test_find_by_id_nil_when_no_match
    assert_equal nil, customer_repo.find_by_id(18)
  end
  ...
  def test_find_by_empty_when_no_match
    assert_equal [], customer_repo.find_all_by_first_name("fake")
  end
  ...
  def test_can_find_all_customers_by_first_name_case_insenstive
    assert_equal 1, customer_repo.find_all_by_first_name("keRRy")[0].id
  end
